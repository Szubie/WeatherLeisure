...
public class WeatherView{
    ...
    public JPanel topBar(){
        //create the top panel telling us waht screen we are in
        JPanel topBar = new JPanel();
        topBar.setPreferredSize(new Dimension(WIDTH, 80));
        topBar.setBackground(darkBlue);
        JLabel screenLabel = new JLabel("WEATHER",
                    JLabel.CENTER);
        screenLabel.setForeground(Color.WHITE);
				screenLabel.setFont(new Font("Century Gothic", Font.BOLD, screenLabelfont));
        topBar.add(screenLabel);
        return topBar;
    }
    ...
    private JPanel weatherDisplay(){
        ...
        weatherDisplay.setBackground(darkBlue);
    ...
    public JPanel bottomPanel(){
        ...
        try{
            buttonIcon = ImageIO.read(new File("images/SettingsButton.png"));
            ...
            buttonIcon = ImageIO.read(new File("images/WeatherButton.png"));
            ...
            buttonIcon = ImageIO.read(new File("images/ProposalButton.png"));
    ...
    private JPanel settingsScreen(){
        ...
        eating.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
				...
				drinking.addItemListener(new ItemListener() {
						...
						public void itemStateChanged(ItemEvent e) {
								if(e.getStateChange() == ItemEvent.SELECTED) {
										model.setDrinking(true);
										updateProposalGrid();
								} else {
										model.setDrinking(false);
										updateProposalGrid();
								};
						}
				});
				...
				fashion.setFont (eating.getFont().deriveFont (settingsFont));
				fashion.addItemListener(new ItemListener() {
						@Override
						public void itemStateChanged(ItemEvent e) {
								if(e.getStateChange() == ItemEvent.SELECTED) {
										model.setFashion(true);
										updateProposalGrid();
								} else {
										model.setFashion(false);
										updateProposalGrid();
								};
						}
				});

				JCheckBox exhibitions = new JCheckBox("Exhibitions");
				exhibitions.setFont (eating.getFont().deriveFont (settingsFont));
				exhibitions.addItemListener(new ItemListener() {
						@Override
						public void itemStateChanged(ItemEvent e) {
								if(e.getStateChange() == ItemEvent.SELECTED) {
										model.setExhibitions(true);
										updateProposalGrid();
								} else {
										model.setExhibitions(false);
										updateProposalGrid();
								};
						}
				});

				JCheckBox justopened = new JCheckBox("Just Opened");
				justopened.setFont (eating.getFont().deriveFont (settingsFont));
				justopened.addItemListener(new ItemListener() {
						@Override
						public void itemStateChanged(ItemEvent e) {
								if(e.getStateChange() == ItemEvent.SELECTED) {
										model.setJustOpened(true);
										updateProposalGrid();
								} else {
										model.setJustOpened(false);
										updateProposalGrid();
								};
						}
				});

				JCheckBox fitness = new JCheckBox("Fitness");
				fitness.setFont (eating.getFont().deriveFont (settingsFont));
				fitness.addItemListener(new ItemListener() {
						@Override
						public void itemStateChanged(ItemEvent e) {
								if(e.getStateChange() == ItemEvent.SELECTED) {
										model.setFitness(true);
										updateProposalGrid();
								} else {
										model.setFitness(false);
										updateProposalGrid();
								};
						}
				});
        ...
        settingsPanel.add(eating);
			  ...
			  settingsPanel.add(fashion);
			  settingsPanel.add(exhibitions);
				settingsPanel.add(justopened);
				settingsPanel.add(fitness);
